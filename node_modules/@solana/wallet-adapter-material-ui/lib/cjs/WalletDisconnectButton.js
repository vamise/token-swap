...
const WalletDisconnectButton = (_a) => {
    ...
    return (react_1.default.createElement(material_1.Button, Object.assign({ color: color, variant: variant, type: type, onClick: handleClick, disabled: disabled || !wallet, startIcon: react_1.default.createElement(WalletIcon_1.WalletIcon, { wallet: wallet }) }, props), content));
};
